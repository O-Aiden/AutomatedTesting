...
# 问题单
#excelPath = projectPath + r'/testData/gdce.xlsx'
# 冒烟测试
#excelPath = projectPath + r'/testData/gdceSmokeTest.xlsx'
# story
#excelPath = projectPath + r'/testData/gdce_story.xlsx'
# 添加数据
excelPath = projectPath + r'/testData/addData.xlsx'
#excelPath_testGdceLogin = projectPath + r'/testData/testGdceLogin.xlsx'
